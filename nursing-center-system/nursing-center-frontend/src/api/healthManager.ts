...
export const healthManagerApi = {
  ...
  getCustomerList: (params: BaseQueryParams & { customerName?: string }) => {
    return request.get<PageResponse<Customer>>('/api/health-manager-portal/customers', { params })
  },
  ...
  getCareRecords: (params: BaseQueryParams & { customerId?: number; customerName?: string; startDate?: string; endDate?: string }) => {
    return request.get<PageResponse<CareRecord>>('/api/health-manager-portal/care-records', { params })
  },
...
export function getCustomerList(params: BaseQueryParams & { customerName?: string }) {
  return request.get<PageResponse<Customer>>('/health-manager-portal/customers', { params })
}

// 获取客户的护理项目
export function getCustomerCareItems(customerId: number) {
  return request.get<CareItem>(`/health-manager-portal/customers/${customerId}/care-items`)
}
...
export function executeCare(data: {
  ...
  return request.post<CareRecord>('/health-manager-portal/care-records', data)
}

// 获取护理记录
export function getCareRecords(params: BaseQueryParams & { customerId?: number; customerName?: string }) {
  return request.get<PageResponse<CareRecord>>('/health-manager-portal/care-records', { params })
}

// 隐藏护理记录
export function hideCareRecord(recordId: number) {
  return request.put<void>(`/health-manager-portal/care-records/${recordId}/hide`)
}

// 获取外出申请列表
export function getOutingApplies(params: BaseQueryParams & { customerName?: string; status?: string }) {
  return request.get<PageResponse<OutingApply>>('/health-manager-portal/outing-applies', { params })
}
...
export function createOutingApply(data: {
  ...
  return request.post<OutingApply>('/health-manager-portal/outing-applies', data)
}

// 登记回院
export function registerReturn(applyId: number, actualReturnTime: string) {
  return request.put<void>(`/health-manager-portal/outing-applies/${applyId}/return`, {
    actualReturnTime
  })
}
...
export function getCheckoutApplies(params: BaseQueryParams & { customerName?: string; status?: string }) {
  return request.get<PageResponse<CheckoutApply>>('/health-manager-portal/checkout-applies', { params })
}
...
export function createCheckoutApply(data: {
  ...
  return request.post<CheckoutApply>('/health-manager-portal/checkout-applies', data)
}

// 撤销退住申请
export function cancelCheckoutApply(applyId: number) {
  return request.put<void>(`/health-manager-portal/checkout-applies/${applyId}/cancel`)
}
